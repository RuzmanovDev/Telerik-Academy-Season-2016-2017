...
namespace SocialNetwork.ConsoleClient.Importers
{
    public class Importer : IImporter
    {
        ...
        public void Import()
        {
            var friendships = this.Deserialize<FriendshipXML>("XmlFiles/Friendships-Test.xml", "Friendships");
            this.ProcessFrienships(friendships);

            var posts = this.Deserialize<PostXML>("XmlFiles/Posts-Test.xml", "Posts");
        ...
        private void ProcessPosts(IEnumerable<PostXML> posts)
        {
            ...
            foreach (var xmlPost in posts)
            {
                ...
                var s = this.dataprovider.UserProfiles.GetAll<int>(null, u => u.Id );
